        ...
        <div className="container">
          <div className="content">
            ...
            <p>
              ...
              decorative design for my own living space. <br /> My focus is
              bringing life in glass painting It is like magic, Light and color
              alone can create form, Finding exactly where the light is
              reflected in the eye. <br /> <br /> I hope that my works will be
              used and loved and bring lot's of positive energy and smiles into
              your lives.
            </p>
          </div>
          <div className="content">
            ...
            <p>
              ...
              <br />
              <br /> Dim colorful lights can set the mood for any task, change
              the feeling of your room, for every-night dreamy atmosphere. We
              customize each piece according to your needs, dimensions and mood
              requests. <br /> <br /> Glass can transform to various shapes to
              bring the light to space. Be the flame to spread it or give it a
              chance to reflect joyfully on your life. Surround yourself with
              beauty, give your daily setups a dimension and decorate every
              corner now with Ogme.
            </p>
          </div>
          <div className="content">
            <h2>About bottles</h2>
            <p>
              ...
              to any tableware indoors or outdoors. Will make a beautiful gift.
            </p>
          </div>
          <div className="content">
          ...
          <div className="content ">
            ...
            <p>
              ...
              <span style={{textAlign:"left"}}>
                <b>High-Quality Materials</b><br /> Our ogme drive is made with
                high-quality, durable acrylic We include 5 different shapes,
                ensures it stays securely in place on your rearview mirror or
                anywhere else you choose to display it.
                <br /> <br />
                <b>Easy Installation</b><br /> Installation is a breeze – simply
                attach the car charm to your rearview mirror, visor, or any
                other suitable location. It will instantly add a touch of
                elegance and charm to your car's interior.
                <br /> <br />
                <b>Perfect Gift</b><br /> Looking for a unique and meaningful gift
                for a friend or family member? Ogme drive choice for birthdays,
                holidays, or special occasions. It's a little piece of art that
                can brighten up anyone's day.
                <br /> <br />
                <b>Customization Available</b><br /> Choose from a variety of colors
                to match your car's interior or personal preferences. Whether
                you prefer a classic and timeless look or something more vibrant
                and playful, we have options to suit your taste.
                <br /> <br />
                <b>Handmade with Love</b><br />
